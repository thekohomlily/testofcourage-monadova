...
window.addEventListener('load', function() {
    ...
    //     infoWindow: {
    //         content: '<h4>Waypoint 1</h4><ul><li>アイテムの配置やルートの指定を経由地点の指定に見立てればうまく実装できそう。</li></ul><a href="img/ghost_4.jpg" target="_blank">Preview</a>'  // add info
    //     },
    //     click: function(e) {
    //         this.infoWindow.open(this.map, this);
    //         //alert('hongege'); // When click marker
    ...
    //     animation: google.maps.Animation.DROP,
    //     //clickable: false,
    //     //cursor: "url(./img/ghost_3.jpg), auto" ,
    // });
